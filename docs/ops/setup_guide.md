...
The Clarity Reports dashboard is built with Next.js. To set it up, follow these steps:
...
## 8. Run the Full-Stack Application
...
The backend will be accessible at `http://localhost:8000`, and the dashboard at `http://localhost:3000`.
